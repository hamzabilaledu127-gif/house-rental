...
echo "Return Code: " . $_FILES["file"]["error"] . "<br />";
			...
			$sql="INSERT INTO register(image,fname, lname,email,phone,kebele,housenumber,price,floor,type,date)
VALUES
('$location','$fname','$lname','$email','$phone','$keb','$houseno','$price','$flor','$type','$date')";

if(mysqli_query($con,$sql))
  {
 
    include_once ("posthouse.php");
  //  session_destroy();
