...
<img align="left" border="0" src="IMG/h2.jpg" width="215" height="120" alt="House Rent" title="Gondar City House Rental System" />
&nbsp;
...
<td  bgcolor="  #ffccff "valign="top"height="150px" width="325px" margin-top="0px" border="0px" align-top="0px"><!--center -->
    ...
    <div id="pagetitle" ><!-- InstanceBeginEditable name="pagetitle" --><b> Administrator Page To Edit User Account</b><!-- InstanceEndEditable --></div>
     	</br></br>
...
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>User Name:</b></td><td><input  type="text" name="username" pattern="\w{4,10}" value="<?php echo $row0?>"/></td>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>email:</b></td><td><input type="text" name="email" pattern="(\w[-._\w]*\w@\w[-._\w]*\w\.\w{2,3})" value="<?php echo $row1?>"/></td>
</tr>
 <tr>
<td><font face="times new roman" color="#336699" size="3"><b>Account Type:</b></font></td><td><input  type="text" name="usertype" pattern="\w{4,10}" value="<?php echo $row2?>"/></td>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>Password:</b></td><td><input  type="text" name="password" pattern="\w{4,10}" value="<?php echo $row3?>"/></td>
</tr>
...
<?php
  ...
  $update = mysqli_query($con,("update account set username='$username',email='$email',usertype='$usertype',password='$password' where email='$email'")) or die(mysql_error());
