...
<td  bgcolor="	#ffccff "valign="top"height="150px" width="325px" margin-top="0px" border="0px" align-top="0px"><!--center -->
    ...
    <p><span class="style1">The Following are Our Contact Address :</span></p>
    <p> Developers address  address:
	            <ol><li>Yichalem Gebeyaw: <br> phone N0.0945290196.</li>
				<li> Zerihun Melkamu: <br> phone N0. 0913025689.</li>
				<li> Birhan Haymanot: <br> phone N0. 0928587031.</li>
				<li> Herya Huseen:  <br> phone N0. 0912398670</li>
				<li> Mandefro Cheklie: <br> phone N0. 0921586031.</li>
				<li> Saba Endalkachew:  <br> phone N0. 0937456770</li>
				</li></ol></p><br><br><br><br><br><br><br><br><br><br><br><br/><br/><br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
</td><!--center end--> 
