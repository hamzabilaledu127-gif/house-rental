			...
			$fname=$_POST['fname'];
                  ...
                  // $em = $_SESSION['log']['email'];
                        ...
                        $flor=$_POST['floor'];
                         $type=$_POST['type'];
                        $date=$_POST['date'];
			$sql="INSERT INTO dormitory(image,fname, lname,email,phone,kebele,room,housenumber,price,floor,type,date)
VALUES
('$location','$fname','$lname','$email','$phone','$keb','$room','$houseno','$price','$flor',$type, $date)";
