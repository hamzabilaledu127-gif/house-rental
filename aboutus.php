...
<td  bgcolor="	#ffccff "valign="top"height="150px" width="325px" margin-top="0px" border="0px" align-top="0px"><!--center -->
 ...
 <pre><p> Gondar city house rental system was started around 1987
it is developed from time to time with the development of the City. 
 As it is developed from time to time it increases its capacity by increasing 
