...
<td  bgcolor="	#ffccff "valign="top"height="150px" width="325px" margin-top="0px" border="0px" align-top="0px"><!--center -->
	  ...
	  <div id="pagetitle" ><!-- InstanceBeginEditable name="pagetitle" --><b> Administrator Page to View Customer Request For Account Activation</b><!-- InstanceEndEditable --></div>
     	</br>
...
$query = "SELECT * FROM accountrequest";
...
while($row = mysqli_fetch_array($result))
  ...
  print ("<tr>");
   ...
   print ("<td>" . $row['usertype'] . "</td>");		
		print("<td align = 'center' width = '1'><a href = 'accountrequestdetail.php?key=".$ctrl."'><img width='25px' height='25px' src = 'IMG/aaa.png' title='View Detail'></img></a></td>
		<td><a href = 'sendaccountresponse.php?key=".$ctrl."'><img src = 'images/done.jpg' width='60px' height='25px' title='request' ></img></a></td>
    <td><a href = 'delete.php?key=".$ctrl."'><img src = 'images/remove.png' width='60px' height='25px' title='request' ></img></a></td>
