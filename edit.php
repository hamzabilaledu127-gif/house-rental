...
?>
  ...
  <br><br>
  <center>
 <table valign='bottom' align="center" style="width:250px; height:150px;border-radius:10px;border:1px solid #686868">
  
<tr>
<td></td>
<td align="right"><a href="viewuser.php"><img src="images/close.jpg" title="Close"></a></td></tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>User Name:</b></td><td><input type="text" name="username" required  value="<?php echo $row0?>"/></td>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>email:</b></td><td><input type="text" name="email" required Pattern="[\w\-\.\+]+\@[a-zA-Z0-9\.\-]+\.[a-zA-z0-9]{2,4}" title="please enter valid email" value="<?php echo $row1?>"/></td>
</tr>
 <tr>
<td><font face="times new roman" color="#336699" size="3"><b>Account Type:</b></font></td><td><input type="text"  name="usertype" required value="<?php echo $row2?>" Pattern="[A-Za-z]{3,20}"  title=" it must be charcter"/></td>
</tr>
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>Password:</b></td><td><input  type="text" name="password" required value="<?php echo $row3?>"/></td>
</tr>




<tr><td colspan=2 align='center'><input type='submit' name='submit' value='Update'></tr></td>
</table></center>
 </form>
 <?php
}
...
<?php
  ...
  $update = mysqli_query("update account set username='$username',email='$email',usertype='$usertype',password='$password' where email='$username'") or die(mysql_error());
