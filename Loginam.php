...
<li ><a href="chrome-extension://abjfkdndbfdjlliomgmfblmibdempojg/newtab/blank.html#">አቅጣጫ</a></li> 
    <li><a href="housedatabaseam.php">ቤቱንተመልከት</a></li>
<li><a href="accountrequestcusam.php">የአካውንት ጥያቄ</a></li>
        <li><a href="viewactivationresponseam.php">አካውንት ግብረ መልስ</a></li>
...
<td  bgcolor="	#FFCCFF "valign="top"height="150px" width="325px" margin-top="0px" border="0px" align-top="0px"><!--center -->
	  ...
	  <div id="pagetitle" ><!-- InstanceBeginEditable name="pagetitle" --><b> የመግቢያ ገፅ</b><!-- InstanceEndEditable --></div>
     	</br>
  ...
  <br>
    <div id="middletxtheadermain" align="left"><br/><center><img  src="img/login.gif" width="140px" height="110px" valign="top"  /></center>
      ...
      <div id="middletxt">
        <form action="loginam.php" method="post" name="frm_login" id="frm_login" >
         ...
         <tr>
                 <td width="20" height="37" ><div align="left" margin-left="2px"><strong><font color="#FF0000">*</font>ተጠቃሚ ፡ : </strong></div></td>
            <td  align="left">
          <select id='usertype' name="usertype" required style="width:175px;" "height:20px;" margin-left="2px"  >
            ...
            <option></option>
              ...
              <tr>
                 <td width="80" height="37" ><div align="left"><strong><font color="#FF0000">*</font>የተጠቃሚ ስም : </strong></div></td>
            
                 <td width="80"><input type="tex" name="username" id="username" maxlength="22" style="border:1px #480000 solid;width:176px;height:25px;background:#FFFFFF;border-radius:5px;" required />
                                   
                                   <!--<div class="example">(Only Lower case Allowed.)</div>--></td>
              </tr>
              <tr>
                 <td width="80" height="37"><div align="left"><strong><font color="#FF0000">*</font>የይለፍ ቃል: </strong></div></td>
                 <td width="80"><input type="password" name="password" id="password" maxlength="22" style="border:1px #480000 solid;width:176px;height:25px;background:#FFFFFF;border-radius:5px;" placeholder="" required /></td>
              </tr>
              <tr> <center>
                 <td colspan="3" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 <input type="submit" id="submitMain" name="submitMain" value="ግባ" title="Click here to login" Onclick="return check(this.form);" />
            
         <input type="reset"  value=" አጥፋ " onClick='focusReset()'
...
{
$_SESSION['username']=$row['username'];
echo "<script>window.location='employeeam.php';</script>";
}
else if($account_type=="landlord")
{
$_SESSION['username']=$row['username'];
echo "<script>window.location='landlordam.php';</script>";
}
...
{
    print "<img src='IMG/error.png' align='center' width='35px' height='25px'><I><font face='arial' color='black' size='3'> የመግቢያ  አካዉንትወ ችግር ስላለበት ከሀላፊዉ ጋር ይንጋገሩ!!</font></I>";

}
}
else
   {
     echo '<div align="center"><strong><font color="#FF0000"> የተሳሳተ መረጃ ሞልተዋል እባክዎ እንደገና ይሞክሩ</font></Strong></div>';
   }
