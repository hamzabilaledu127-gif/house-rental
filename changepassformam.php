...
<FORM name="register" enctype="multipart/form-data" ACTION="changepass.php" METHOD="post" onSubmit="return register_validation()">
     ...
     <table width="20px" align="center" style="border:px solid #000;border-radius:px">  
          <br><br>
          <tr>
             <td class='para1_text' width="20px"><font color="red">*</font> የተጠቃሚ ስም :</td></tr><tr><td><input type="text" name="un" required x-moz-errormessage="Enter your user name" ></td>
	     </tr>
	 <tr>
             <td class='para1_text' width="20px"><font color="red">*</font> ነባር የይለፍ ቃል አስገባ:</td></tr><tr><td><input type="password" name="password" required x-moz-errormessage="Enter your current password " ></td>
	     </tr>
		  <tr>
                      <td class='para1_text' width="px"><font color="red">*</font> አዲስ የይለፍ ቃል አስገባ:</td></tr><tr><td width="10px"><input type="password" name="passwrd" required x-moz-errormessage="Enter your new password" ></td>
	     </tr>
  <tr>
    
	<br><br><br>
    <td><input type="submit" name="login" value="ቀይር" />&nbsp;&nbsp;<input type="reset" value="አጥፋ" /></td>
    </tr></table></form>	
