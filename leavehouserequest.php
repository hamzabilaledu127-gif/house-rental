...
$con = mysqli_connect('localhost','root', '','house');//Records per page?>
 ...
 <FORM ACTION="leavehouserequest.php" METHOD="POST" enctype="multipart/form-data">
...
<tr>
<td>HouseNumber :</td><td><input name="housenumber" type="number" size"20" pattern="\D{4,50}" title="it must be number" required Pattern="[0-9]{1,10}"  placeholder="Enter housenumber"></input></td>
</tr>
<tr>
<tr>
      <td >Reason: </td>
