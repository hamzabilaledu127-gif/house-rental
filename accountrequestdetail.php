...
<td  bgcolor="  #ffccff "valign="top"height="150px" width="325px" margin-top="0px" border="0px" align-top="0px"><!--center -->
    ...
    <div id="pagetitle" ><!-- InstanceBeginEditable name="pagetitle" --><b> Administrator Page To View Detail Customer Account Activation Request</b><!-- InstanceEndEditable --></div>
      </br>


  <?php
$ctrl = $_REQUEST['key'];
$query="SELECT * FROM  accountrequest where username='{$ctrl}'";
...
<tr>
<td></td>
<td align="right"><a href="accountrequest.php"><img src="IMG/close.jpg" title="Close"></a></td></tr>
 <tr>
...
<tr>
<td><font face="times new roman" color="#336699" size="3"><b>UserType:</b></td><td><?php echo $row2?></td>
</tr>
<tr>
