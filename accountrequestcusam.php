...
$con = mysqli_connect('localhost','root', '','house');//Records per page?>
 ...
 <FORM ACTION="accountrequestcusam.php" METHOD="POST" enctype="multipart/form-data">
<font face="timesnewroman">


<center>
<table  bgcolor="#ffccff" style="border:0px solid black;width:400px;border-radius:10px">
<tr>
<td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;የተጠቃሚ ስም፡ :</td><td><input name="username" type="text" size"20"  required  pattern=""  title="Enter username here"></input></td>
</tr> 
 ...
 <tr>
      <td >&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;መልክት አስገባ፡: </td>
      <td bgcolor=""><label>
              <textarea colspan="2" cols="22" rows="3" name="message" value=" " required></textarea><br>
      </label></td>
         </tr>
...
<input type="submit" value="አስገባ" name="add"/> <input type="reset" value=" አጥፋ"/>
</td></tr>
...
<?php
 ...
 $username=$_POST['username'];
         $date=$_POST['date'];
  $sql="select * from account where username='{$username}' AND usertype='customer' AND status='0'";
 ...
 // $email=$row['email'];
   //$time=date("d/M/Y");
$sql="insert into accountrequest (username,email,usertype,message,date)
  values('$_POST[username]','$email','$usertype','$_POST[message]','$date')";  
     $result=mysqli_query($con,$sql);  
if(!$result){
    print "<img src='IMG/error.png' align='center' width='25px' height='25px'>
    <font face='arial' color='red' size='2'> የተሳሳተ መረጃ ሞልተዋል እባክዎ እንደገና ይሞክሩ!!
  </font>";
   echo' <meta content="5;accountrequestcusam.php" http-equiv="refresh" />'; 
}
