...
<br>   <br><br><br><br><br> 
       ...
       <p align="center" > <a href="services.php">Services</a></p>
        <p align="center" > <a href="forgot.php">ForgotPassword</a></p>
...
<td  bgcolor="	#ffccff "valign="top"height="150px" width="325px" margin-top="0px" border="0px" align-top="0px"><!--center -->
	  ...
	  <div id="pagetitle" ><!-- InstanceBeginEditable name="pagetitle" --><b> User Account Change Password Form</b><!-- InstanceEndEditable --></div>
     	</br>
<FORM name="register" enctype="multipart/form-data" ACTION="changepass.php" METHOD="post" onSubmit="return register_validation()">

     <table width="20px" align="center" style="border:px solid #000;border-radius:px">  
          <br><br>
          <tr>
             <td class='para1_text' width="20px"><font color="red">*</font> User Name</td></tr><tr><td><input type="text" name="un" required x-moz-errormessage="Enter your user name" ></td>
	     </tr>
	 <tr>
             <td class='para1_text' width="20px"><font color="red">*</font> Current password:</td></tr><tr><td><input type="password" name="password" required x-moz-errormessage="Enter your current password " ></td>
	     </tr>
		  <tr>
                      <td class='para1_text' width="px"><font color="red">*</font> New password:</td></tr><tr><td width="10px"><input type="password" name="passwrd" required x-moz-errormessage="Enter your new password" ></td>
	     </tr>
  <tr>
    
	<br><br><br>
    <td><input type="submit" name="login" value="change" />&nbsp;&nbsp;<input type="reset" value="Clear" /></td>
    </tr></table></form>	
