...
<tr>
<td align="center" bgcolor="#996633"><span class="style2"><strong>user name</strong></span></td>
<td width="29%" align="center" bgcolor="#996633"><span class="style2"><strong>email</strong></span></td>
<td width="18%" align="center" bgcolor="#996633"><span class="style2"><strong>housenumber</strong></span></td>
<td width="23%" align="center" bgcolor="#996633"><span class="style2"><strong>reason</strong></span></td>
...
<td width="18%" bgcolor="#FFFFFF"><?php echo $rows['housenumber']; ?></td>
<td width="23%" bgcolor="#FFFFFF"><?php echo $rows['reason']; ?></td>
<td width="23%" bgcolor="#FFFFFF"><?php echo $rows['date']; ?></td>


<td width="11%" bgcolor="brown"><a href="deleterequestemp.php?housenumber=<?php echo $rows['housenumber']; ?>"><img src="IMG/remove.jpg" width="90"hight="40"/></a></td>
</tr>
<?php
