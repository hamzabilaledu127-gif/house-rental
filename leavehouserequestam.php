...
$con = mysqli_connect('localhost','root', '','house');//Records per page?>
 ...
 <FORM ACTION="leavehouserequestam.php" METHOD="POST" enctype="multipart/form-data">
<font face="timesnewroman">

<center>
<table  bgcolor="#ffccff" style="border:0px solid black;width:400px;border-radius:15px">
<tr>
<td>የተመቃሚ ስም:</td><td><input name="username" type="text" size"20"  required="required" placeholder=""></input></td>
</tr><tr>
<td>ኢሜይል:</td><td><input name="email" type="text" size"20"  required Pattern="[\w\-\.\+]+\@[a-zA-Z0-9\.\-]+\.[a-zA-z0-9]{2,4}" title="please enter valid email"></input></td>
</tr>
<tr>
<td>የቤት ቁጥር   :</td><td><input name="housenumber" type="text" size"20" pattern="\D{4,50}" title="it must be number" required Pattern="[0-9]{1,10}"  placeholder=""></input></td>
</tr>
<tr>
<tr>
      <td >ምክንያት: </td>
...
$sql="insert into leavehouserequest (username,email,housenumber,message,date)
...
if(!$result){
   ...
   echo' <meta content="5;leavehouserequestam.php" http-equiv="refresh" />'; 
}
